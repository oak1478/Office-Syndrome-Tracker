...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)"); // เพิ่ม useEffect
...
function NewRecordPage() {
    ...
    // จัดการการเปลี่ยนหน้าผ่าน useEffect เพื่อป้องกัน Error ระหว่าง Render
    ...
    // ตัวแปรเก็บข้อมูลอาการทางกายภาพ
    ...
    // หากไม่มีเซสชัน ให้ส่งกลับเป็น null ระหว่างรอ useEffect ทำงาน
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (response.ok) {
                alert("บันทึกข้อมูลสุขภาพประจำวันเรียบร้อยแล้ว");
                router.push("/records");
                router.refresh();
            } else {
    ...
    return(// ... เนื้อหา JSX ส่วนที่เหลือของท่านโอ๊คคงเดิมได้เลยครับ ...
...
//# sourceMappingURL=%5Broot-of-the-server%5D__989aedc7._.js.map