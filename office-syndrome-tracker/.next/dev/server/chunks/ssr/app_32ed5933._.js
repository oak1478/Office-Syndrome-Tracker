...
function DashboardPage() {
            ...
            if (status === "authenticated") {
                try {
                    ...
                    if (res.ok) {
                        ...
                        setAllRecords(data);
                    // ถ้าเดือนปัจจุบันไม่มีข้อมูล แต่มีข้อมูลในเดือนอื่น 
                    // ระบบจะยังคงอยู่ที่เดือนปัจจุบันเป็นค่าเริ่มต้นเพื่อให้ผู้ใช้เริ่มบันทึกใหม่
                    }
                } catch (error) {
    ...
    /**
   * Logic: ค้นหาเดือนและปีที่มีข้อมูลบันทึกอยู่จริงในระบบ
   * เพื่อนำมาสร้างรายการตัวเลือกใน Dropdown
   */ const availableOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        // เพิ่มเดือนปัจจุบันเข้าไปเป็นตัวเลือกเสมอ (แม้ยังไม่มีบันทึก)
        const currentM = new Date().getMonth();
        const currentY = new Date().getFullYear();
        options.push({
            month: currentM,
            year: currentY,
            label: `${months[currentM]} ${currentY + 543}`
        });
        seen.add(`${currentM}-${currentY}`);
        // ไล่เช็คจาก records ทั้งหมดว่ามีเดือนไหนบ้าง
...
//# sourceMappingURL=app_32ed5933._.js.map