...
"[project]/app/api/records/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    try {
        ...
        const record = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].healthRecord.findUnique({
            where: {
...
async function PUT(req, { params }) {
    try {
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].healthRecord.update({
            where: {
                id: resolvedParams.id
            },
            data: {
...
async function DELETE(req, { params }) {
    try {
        const resolvedParams = await params;
        await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].healthRecord.delete({
            where: {
                id: resolvedParams.id
            }
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: "ดำเนินการลบข้อมูลสำเร็จ"
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6c9e5add._.js.map